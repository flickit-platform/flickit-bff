...
urlpatterns = [
    ...
    path('<str:expert_group_id>/leave/', expert_group_views.LeaveExpertGroupAPi.as_view()),
    ...
    path('<str:expert_group_id>/invite/<str:invite_token>/confirm/',
         expert_group_views.ExpertGroupInviteMembersConfirmApi.as_view()),
]
